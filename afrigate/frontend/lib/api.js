...
export const api = {
  ...
  adminUpdateFxRates: (body) => request("/api/admin/settings/fx-rates", { method: "PUT", body }),
  adminSetFxAutoUpdate: (enabled) => request("/api/admin/settings/fx-auto-update", { method: "PUT", body: { enabled } }),
  adminSyncFxNow: () => request("/api/admin/settings/sync-fx-now", { method: "POST" }),
